...
final class ParticipantView: UIView {
    ...
    private var tableBuilder: ParticipantTableBuilder?
    ...
    private func initData(with entity: ParticipantResults? = nil) {
        tableBuilder = ParticipantTableBuilder(
            tableView: tableView,
            entity: entity
        )
    }
    ...
    func updateAppearance(with entity: ParticipantResults, animated: Bool = true) {
        tableBuilder?.updateParticipant(entity, animated: animated)
    }
