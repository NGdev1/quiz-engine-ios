...
final class QuizPassingTableBuilder {
    ...
    private var cellsSetup: QuizPassingCellSetup
    ...
    init(tableView: UITableView, entity: QuizPassing?) {
        ...
        self.cellsSetup = QuizPassingCellSetup(entity: entity, tableView: tableView)
    }
    ...
    func updateQuiz(_ entity: QuizPassing, animated: Bool) {
        self.entity = entity
        cellsSetup.updatEntity(entity)
